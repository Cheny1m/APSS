...
def get_options(args=[]):
    ...
    # Data
    parser.add_argument('--problem', default='pp', help="The problem to solve, default 'pp'")
    ...
    parser.add_argument('--output_dir', default='outputs1', help='Directory to write output models to')
    ...
    opts.use_cuda = context.get_context("device_target") == "GPU" and not opts.no_cuda
