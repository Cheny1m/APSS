...
class AttentionModel(nn.Module):
    ...
    def _inner(self, input, embeddings):
        ...
        while True:#not (self.shrink_size is None and state.all_finished()):
            ...
            # Select the indices of the nextS nodes in the sequences, result (batch_size) long
            ...
            if num_steps == 1:  # We need to special case if we have only 1 step, may be the first or not
                ...
                if state.i.item() == 0:
                    ...
                    return embeddings.gather(
                        1,
                        current_node[:, :, None].expand(batch_size, 2, embeddings.size(-1))
                    ).view(batch_size, 1, -1)
